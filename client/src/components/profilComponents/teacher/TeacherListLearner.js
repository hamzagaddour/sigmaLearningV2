...
import { deleteUser, disableUser, enableUser } from "../../../actions/user.actions";
import DialogTest from "../adminListLearner/Dialog/DialogLearnerUpdate";
...
const AdminListLearner = () => {
  ...
  const [selectedValueLearnerUpdate, setSlectedValueLearnerUpdate] = useState("");
